...
class RM extends Model
{
    ...
    protected $fillable = ['id', 'arrival_date', 'partai', 'species_id', 'category_id', 'supplier_id', 'pcs', 'm2', 'm3', 'grade_id', 'invoice_dimention_id','phisic_dimention_id','itemproduct_id','status', 'approval_to', 'warehouse_rm_id', 'reason_reject'];
