    ...
    <div class="page-content container-fluid">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('master.productionline.store') }}" method="post" class="form-horizontal" id="exampleConstraintsFormTypes" autocomplete="off">
                @csrf
                            ...
                            <div class="example-wrap m-md-0">
                                <div class="example">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                            <input type="text" class="form-control" id="codeprodline" name="codeprodline">
                                            </div>
                                        </div>
                                </div>
                            </div>
